...
{var pred__10511 = cljs.core._EQ_;var expr__10512 = limit;if(cljs.core.truth_(pred__10511.call(null,1,expr__10512)))
...
var G__10514 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10515 = (limit__$1 - 1);
var G__10516 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10514;
limit__$1 = G__10515;
parts = G__10516;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10518 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10518))
{var replacement_10519 = temp__4090__auto___10518;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10519)));
} else
{buffer.append(ch);
}
{
var G__10520 = (index + 1);
index = G__10520;
continue;
}
}
