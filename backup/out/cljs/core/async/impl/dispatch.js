...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13253 = 0;while(true){
var m_13254 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13254 == null))
{} else
{m_13254.call(null);
if((count_13253 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13255 = (count_13253 + 1);
count_13253 = G__13255;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3526__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3526__auto__)
