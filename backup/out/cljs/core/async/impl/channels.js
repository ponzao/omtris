...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13259 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13259 = (function (val,box,meta13260){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13259.cljs$lang$type = true;
cljs.core.async.impl.channels.t13259.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13259";
cljs.core.async.impl.channels.t13259.cljs$lang$ctorPrWriter = (function (this__4105__auto__,writer__4106__auto__,opt__4107__auto__){return cljs.core._write.call(null,writer__4106__auto__,"cljs.core.async.impl.channels/t13259");
});
cljs.core.async.impl.channels.t13259.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13259.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13261){var self__ = this;
var _13261__$1 = this;return self__.meta13260;
});
cljs.core.async.impl.channels.t13259.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13261,meta13260__$1){var self__ = this;
var _13261__$1 = this;return (new cljs.core.async.impl.channels.t13259(self__.val,self__.box,meta13260__$1));
});
cljs.core.async.impl.channels.__GT_t13259 = (function __GT_t13259(val__$1,box__$1,meta13260){return (new cljs.core.async.impl.channels.t13259(val__$1,box__$1,meta13260));
});
}
return (new cljs.core.async.impl.channels.t13259(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4108__auto__,writer__4109__auto__,opts__4110__auto__){return cljs.core._write.call(null,writer__4109__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4105__auto__,writer__4106__auto__,opt__4107__auto__){return cljs.core._write.call(null,writer__4106__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13262 = self__.takes.pop();if((taker_13262 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13262))
{var take_cb_13263 = cljs.core.async.impl.protocols.commit.call(null,taker_13262);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13263,taker_13262,this$__$1){
return (function (){return take_cb_13263.call(null,null);
});})(take_cb_13263,taker_13262,this$__$1))
);
} else
{}
{
